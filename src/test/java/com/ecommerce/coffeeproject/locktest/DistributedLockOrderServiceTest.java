...
import com.ecommerce.coffeeproject.domain.order.service.DistributedLockOrderFacade;
...
class DistributedLockOrderServiceTest {

    @MockitoBean
    private DataPlatformClient dataPlatformClient;

    private final DistributedLockOrderFacade distributedLockOrderFacade;
    ...
    @Autowired
    DistributedLockOrderServiceTest(
            DistributedLockOrderFacade distributedLockOrderFacade,
        ...
        this.distributedLockOrderFacade = distributedLockOrderFacade;
    ...
    @Test
    void 동시에_20번_주문해도_분산락으로_정확히_10번만_차감된다() throws InterruptedException {
        int requestCount = 20;
        ...
        for (int i = 0; i < requestCount; i++) {
            executorService.submit(() -> {
                try {
                    ...
                    distributedLockOrderFacade.createOrder(new OrderCreateRequest(memberId, menuId));
    ...
    private void printScenario(
        ...
        System.out.println();
        System.out.println("========================================");
        System.out.println("분산락 동시성 테스트 시나리오");
        System.out.println("========================================");
        System.out.println("테스트 대상       : 포인트 차감 주문 로직");
        System.out.println("락 방식           : Redis 분산락 Redisson RLock");
        System.out.println("락 키             : lock:point:{userId}");
